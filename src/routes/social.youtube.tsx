...
export const Route = createFileRoute("/social/youtube")({
  head: () => ({ meta: [{ title: "YouTube — Sangam Matrimony" }] }),
  component: () => {
    const Icon = Youtube;
    const name = "YouTube";
    return (
      <SiteLayout>
        ...
        <section className="mx-auto max-w-2xl px-4 pb-20 sm:px-6 lg:px-8">
          <div className="rounded-3xl border border-border bg-card p-10 text-center shadow-soft">
            ...
            <p className="text-muted-foreground">Sangam Matrimony</p>
            ...
            <div className="mt-8 flex justify-center gap-3">
              <Button className="bg-gradient-primary shadow-glow" asChild><a href="#" target="_blank" rel="noopener">Subscribe on {name}</a></Button>
